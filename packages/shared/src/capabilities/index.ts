...
const capabilityRecords = validateCapabilityRecords([
  ...
  },
  {
    ...
    evidence: [
      ...
      'Startup lifecycle persistence, scheduling, checkpoint snapshots, and node execution append evidence_items rows linked to mission/task state and replay refs',
  ...
  },
  {
    ...
    blockers: [
      ...
      'Dependency advancement marks nodes ready and checkpoint snapshots exist, but retry, recovery, and rollback over the mission DAG are incomplete',
