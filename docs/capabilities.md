...
| `evidence_ledger`            | `prototype`   | HELM Governance Eval and Recovery Eval                         | Core receipt/Tool Broker/browser/computer/connector/pipeline/ingestion/artifact/lifecycle/eval writers append evidence_items and replay lookup/sequence endpoints exist, but non-workspace scheduled ingestion and legacy writer coverage is incomplete |
