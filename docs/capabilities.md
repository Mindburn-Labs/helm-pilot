...
| `evidence_ledger`            | `prototype`   | HELM Governance Eval and Recovery Eval                         | Core receipt/browser/computer/artifact/eval writers append evidence_items, but integration/lifecycle coverage is incomplete |
