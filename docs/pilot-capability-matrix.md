...
| `evidence_ledger`            | `prototype`   | HELM Governance Eval and Recovery Eval                         | Core receipt/Tool Broker/browser/computer/connector/pipeline/ingestion/artifact/lifecycle/eval writers append evidence_items, but non-workspace scheduled ingestion and legacy writer coverage is incomplete |
