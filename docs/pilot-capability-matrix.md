...
| `command_center`             | `prototype`   | Command Center Real-State UX Eval                              | Real task/action/evidence/receipt/browser/computer, permission graph, mission graph, and eval-status rows are visible, but mission DAG autonomy is still blocked |
