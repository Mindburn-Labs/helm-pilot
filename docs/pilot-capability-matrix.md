...
| `evidence_ledger`            | `prototype`   | HELM Governance Eval and Recovery Eval                         | Core receipt/browser/computer writers append evidence_items, but artifact/eval/integration/lifecycle coverage is incomplete |
