...
| `startup_lifecycle`          | `prototype`   | Full Startup Launch Eval                                       | Founder goals compile into governed lifecycle DAG drafts, but mission runtime execution and eval promotion are incomplete |
