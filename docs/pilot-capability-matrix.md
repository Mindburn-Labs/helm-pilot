...
| `evidence_ledger`            | `prototype`   | HELM Governance Eval and Recovery Eval                         | Core receipt/browser/computer/connector/artifact/lifecycle/eval writers append evidence_items, but background job/tool coverage is incomplete |
