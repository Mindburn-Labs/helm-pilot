...
| `evidence_ledger`            | `prototype`   | HELM Governance Eval and Recovery Eval                         | Core receipt/browser/computer/artifact/lifecycle/eval writers append evidence_items, but integration/tool coverage is incomplete |
