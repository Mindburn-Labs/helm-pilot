...
| `evidence_ledger`            | `prototype`   | HELM Governance Eval and Recovery Eval                         | Core receipt/browser/computer/eval writers append evidence_items, but artifact/integration/lifecycle coverage is incomplete |
