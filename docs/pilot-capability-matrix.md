...
| `evidence_ledger`            | `prototype`   | HELM Governance Eval and Recovery Eval                         | Core receipt/Tool Broker/browser/computer/connector/artifact/lifecycle/eval writers append evidence_items, but background ingestion/legacy writer coverage is incomplete |
