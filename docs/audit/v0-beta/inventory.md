...
| `skills/builder-landing/SKILL.md` | Markdown | 5.8KB | Creates index.html + provider deploy config and Stripe price. | REFACTOR | `services/product-factory/` build task type: landing page. | Medium |
